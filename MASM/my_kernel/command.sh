...
gcc -I lib/kernel/ -I lib/  -c -fno-builtin -o build/init.o kernel/init.c -m32 &&
...
ld -Ttext 0xc0001500 -e main -o build/kernel.bin -m elf_i386  build/main.o  build/print.o build/kernel.o build/init.o build/interrupt.o && 
