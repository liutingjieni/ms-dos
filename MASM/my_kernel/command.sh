...
ld -Ttext 0xc0001500 -e main -o build/kernel.bin -m elf_i386  build/main.o  build/print.o build/kernel.o build/init.o build/interrupt.o build/timer.o build/debug.o build/memory.o build/bitmap.o  build/string.o&& 
