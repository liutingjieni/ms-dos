...
ld -Ttext 0xc0001500 -e main -o build/kernel.bin -m elf_i386  build/main.o build/print.o build/kernel.o build/init.o build/interrupt.o build/timer.o build/thread.o build/debug.o build/memory.o build/bitmap.o  build/string.o build/switch.o build/list.o build/console.o build/sync.o build/keyboard.o build/ioqueue.o build/tss.o&& 
